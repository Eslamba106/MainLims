...
@section('content')
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">{{ translate('feature_section') }}</h4>
                ...
                <div class="d-flex no-block justify-content-end align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ translate('feature_section') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
        ...
        <!-- Start Page Content -->
        <!-- ============================================================== -->
        <form action="{{ route('admin.landing_page_settings.feature.update') }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="row">
                <div class="col-12">
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="image" id="image"
                                            ...
                                            accept="image/*"
                                            data-default-file="{{ (isset($image) && $image->key == 'feature_image' ) ? asset( main_path().$image->value) : asset(main_path().'assets/images/me.png') }}">
                                        @error('image')
