...
@section('content')
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">{{ __('roles.coa_template_designer') }}</h4>
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">{{ __('roles.template_settings') }}</h4>
                <div class="d-flex align-items-center">
                ...
                <div class="d-flex no-block justify-content-end align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('roles.template_settings') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-6">
                    ...
                    @if (check_coa_settings('digital_signature'))
                        <img src="https://via.placeholder.com/100x50?text=Signature" alt="Signature">
                    @endif
                </div>
            </div>
        @endif
