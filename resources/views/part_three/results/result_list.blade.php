                    ...
                    <tbody>
                        @forelse ($results as $result_item)
                            <tr>
                                ...
                                <td class="text-center">{{ $result_item->result_number }} </td>
                                ...
                                <td class="text-center">{{ optional($result_item->sample_main)->name }} </td>
                                ...
                                <td class="text-center">
                                    ...
                                    @endphp
                                    <span
                                        class="badge {{ $statusColors[$result_item->status] ?? 'bg-yellow text-dark' }}">
                                        {{ $result_item->status }}
                                    </span>
                                </td>
                                ...
                                <td class="text-center">
                                    ...
                                    @endcan
                                    @can('create_result')
                                        <a href="{{ route('admin.result.create', $result_item->id) }}"
                                            class="btn btn-outline-warning text-dark btn-sm" title="@lang('result.add_results')">@lang('results.add_result')</a>
                                    @endcan
                                </td>
                            </tr>
                        @empty
