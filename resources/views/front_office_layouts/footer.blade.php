    <footer class="ud-footer wow fadeInUp" data-wow-delay=".15s">
        <div class="shape shape-1">
            <img src="{{ asset(main_path().'landing/assets/images/footer/shape-1.svg') }}" alt="shape" />
        </div>
        <div class="shape shape-2">
            <img src="{{ asset(main_path().'landing/assets/images/footer/shape-2.svg') }}" alt="shape" />
        </div>
        <div class="shape shape-3">
            <img src="{{ asset(main_path(). 'landing/assets/images/footer/shape-3.svg') }}" alt="shape" />
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <p class="ud-footer-bottom-right">
                            ...
                            <a href="https://mostaql.com/u/Eslamba106" rel="nofollow">Eslam Badawy</a>
                        </p>
                    </div>
                </div>
            </div>
