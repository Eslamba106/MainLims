            ...
            <div class="row g-5 align-items-center mb-5">
                ...
                <div class="col-lg-6">
                    <div class="owl-carousel header-carousel animated fadeIn">
                        <img class="img-fluid" src="{{ asset(main_path().('landing/img/hero-slider-1.jpg')) }}" alt="">
                        <img class="img-fluid" src="{{ asset(main_path().('landing/img/hero-slider-2.jpg')) }}" alt="">
                        <img class="img-fluid" src="{{ asset(main_path().('landing/img/hero-slider-3.jpg')) }}" alt="">
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-6 wow fadeIn" data-wow-delay="0.1s">
                            <img class="img-fluid" src="{{ asset(main_path().('landing/img/about-1.jpg'))}}" alt="">
                        </div>
                        <div class="col-6 wow fadeIn" data-wow-delay="0.3s">
                            <img class="img-fluid h-75" src="{{ asset(main_path().('landing/img/about-2.jpg'))}}" alt="">
                    ...
                    <div class="row g-0">
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.2s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset(main_path().('landing/img/project-1.jpg')) }}" alt="">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset(main_path().('landing/img/project-2.jpg')) }}" alt="">
                                <a class="project-overlay text-decoration-none" href="#!">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.4s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset(main_path().('landing/img/project-3.jpg')) }}" alt="">
                                <a class="project-overlay text-decoration-none" href="#!">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset(main_path().('landing/img/project-4.jpg')) }}" alt="">
                                <a class="project-overlay text-decoration-none" href="#!">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.6s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset(main_path().('landing/img/project-5.jpg')) }}" alt="">
                                <a class="project-overlay text-decoration-none" href="#!">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.7s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset(main_path().('landing/img/project-6.jpg')) }}" alt="">
                                <a class="project-overlay text-decoration-none" href="#!">
                    ...
                    <div class="row g-0">
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.2s">
                            <div class="service-item h-100 d-flex flex-column justify-content-center bg-primary">
                                <a href="#!" class="service-img position-relative mb-4">
                                    <img class="img-fluid w-100" src="{{ asset(main_path().('landing/img/service-1.jpg')) }}" alt="">
                        ...
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.4s">
                            <div class="service-item h-100 d-flex flex-column justify-content-center bg-light">
                                <a href="#!" class="service-img position-relative mb-4">
                                    <img class="img-fluid w-100" src="{{ asset(main_path().('landing/img/service-2.jpg')) }}" alt="">
                                    <h3>Implement</h3>
                                </a>
                                <p class="mb-0">Erat ipsum justo amet duo et elitr dolor, est duo duo eos lorem sed diam
                                    stet diam sed stet lorem.</p>
                        ...
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.6s">
                            <div class="service-item h-100 d-flex flex-column justify-content-center bg-light">
                                <a href="#!" class="service-img position-relative mb-4">
                                    <img class="img-fluid w-100" src="{{ asset(main_path().('landing/img/service-3.jpg')) }}" alt="">
                                    <h3>Renovation</h3>
                                </a>
                                <p class="mb-0">Erat ipsum justo amet duo et elitr dolor, est duo duo eos lorem sed diam
                                    stet diam sed stet lorem.</p>
                        ...
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.8s">
                            <div class="service-item h-100 d-flex flex-column justify-content-center bg-primary">
                                <a href="#!" class="service-img position-relative mb-4">
                                    <img class="img-fluid w-100" src="{{ asset(main_path().('landing/img/service-4.jpg')) }}" alt="">
                                    <h3>Commercial</h3>
                                </a>
                                <p class="mb-0">Erat ipsum justo amet duo et elitr dolor, est duo duo eos lorem sed diam
                                    stet diam sed stet lorem.</p>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="team-item position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="{{ asset(main_path().('landing/img/team-1.jpg')) }}" alt="">
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <div class="team-item position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="{{ asset(main_path().('landing/img/team-2.jpg')) }}" alt="">
                        <div class="team-overlay">
                            <small class="mb-2">Architect</small>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="team-item position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="{{ asset(main_path().('landing/img/team-3.jpg')) }}" alt="">
                        <div class="team-overlay">
                            <small class="mb-2">Architect</small>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="team-item position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="{{ asset(main_path().('landing/img/team-4.jpg')) }}" alt="">
                        <div class="team-overlay">
                            <small class="mb-2">Architect</small>
                    ...
                    <div class="owl-carousel testimonial-carousel wow fadeIn" data-wow-delay="0.2s">
                            ...
                            <div class="row g-5 align-items-center">
                                <div class="col-md-6">
                                    <div class="testimonial-img">
                                        <img class="img-fluid" src="{{ asset(main_path().('landing/img/testimonial-1.jpg')) }}" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="testimonial-item">
                            <div class="row g-5 align-items-center">
                                <div class="col-md-6">
                                    <div class="testimonial-img">
                                        <img class="img-fluid" src="{{ asset(main_path().('landing/img/testimonial-2.jpg')) }}" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="testimonial-text pb-5 pb-md-0">
                        ...
                        <div class="testimonial-item">
                            <div class="row g-5 align-items-center">
                                <div class="col-md-6">
                                    <div class="testimonial-img">
                                        <img class="img-fluid" src="{{ asset(main_path().('landing/img/testimonial-3.jpg')) }}" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="testimonial-text pb-5 pb-md-0">
        ...
        <div class="container p-0">
            <div class="row g-0 align-items-center">
                <div class="col-md-5 ps-lg-0 text-start wow fadeIn" data-wow-delay="0.2s">
                    <img class="img-fluid w-100" src="{{ asset(main_path().('landing/img/newsletter.jpg')) }}" alt="">
                </div>
