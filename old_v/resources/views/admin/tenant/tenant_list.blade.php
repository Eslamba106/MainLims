...
<?php $lang = Session::get('locale'); ?>
    ...
    {{ __('roles.tenant_items_management') }}
@endsection
@section('content')
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">{{ __('roles.tenant_items_management') }}</h4>
                        ...
                        @forelse ($tenants as $tenant_items)
                            <tr>
                                ...
                                {{-- <td class="text-center">
                                    @can('delete_tenant_items') 
                                        <a href="{{ route('tenant_items.delete', $tenant_items->id) }}"
                                            class="btn btn-danger btn-sm" title="@lang('dashboard.delete')"><i
                                                class="fa fa-trash"></i></a>
                                    @endcan
                                    @can('edit_tenant_items') 
                                        <a href="{{ route('tenant_items.edit', $tenant_items->id) }}"
